...
const BOOKS = [
  ...
  '{author:"筱乜",filtered_title:"中古手稿-七",generation:2,pages:[\'{"text":"罗非：\\\\n愿你安好。\\\\n久不见你来信，我心甚忧。我找到了新的卓越卷轴，咒符。\\\\n它可以将几乎任何物品转化为自持的施法物品。\\\\n而且，如果以不同的方式激发它，它施法时的初始栈也会是不同的数，如果搭配上选择之馏化，就可以随机应变的使用咒符施法了。\\\\n......\\\\n我还是很担心你，为何久不"}\',\'{"text":"来信？你往日绝不如此。\\\\n你到底在干什么呢？\\\\n\\\\n你的朋友\\\\n筱乜"}\'],title:"中古手稿-七"}'
];
ServerEvents.customCommand("givebook",e=>{
  let player = e.player
  BOOKS.forEach(e=>{
    let item = Item.of("minecraft:written_book",e)
    player.give(item)
  })
})
